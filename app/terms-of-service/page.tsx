  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">2.1 Non-Refundable Deposit and Payment Schedule</h3>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">2.2 Hosting Services and Subscription Payments</h3>
        ...
        <p className="mb-6">
          Subscription payments are billed on either the 1st or 15th of the month, depending on which date is closest to the initial deployment date. Subscription fees will continue to be charged until the Client cancels the subscription by emailing <a href="mailto:accounts@datalinc.io" className="text-blue-600 hover:underline">accounts@datalinc.io</a>. No other cancellation methods will be accepted at this time, as it is a manual process. If the payment fails, the client will be notified, and the subscription will be cancelled, along with the website hosting if not resolved within 14 days. If the payment is resolved, the subscription will be reinstated.
        </p>
        
        <h3 className="text-xl font-semibold mt-6 mb-3">2.3 Content Ownership and Copyright Responsibility</h3>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          <li>Any supplied content must comply with applicable size limits and restrictions on the number of images or videos.</li>
          <li>The Client owns or has the legal right to use the supplied content.</li>
          <li>The Client assumes full responsibility for any copyright infringements or legal claims that may arise from the use of supplied content.</li>
          <li>Datalinc does not claim ownership over the Client&apos;s supplied content.</li>
          <li>All content supplied by the Client will be stored on the servers under control of Datalinc Pty Ltd.</li>
          <li>The code written by Datalinc Pty Ltd is owned by Datalinc Pty Ltd. But a copy may be transferred to the Client upon request, less any intellectual property rights or any code that may be required to be kept by Datalinc Pty Ltd for legal or privacy reasons.</li>
        </ul>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">3.1 Account Termination</h3>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          <li>The Client&apos;s use of or inability to use the service.</li>
          <li>Any errors, delays, or technical issues related to the service.</li>
          <li>Any content supplied by the Client that causes legal claims or damages.</li>
        </ul>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          <li>The Client&apos;s breach of these Terms of Service.</li>
          <li>The Client&apos;s use of the service.</li>
          <li>Any content provided by the Client that infringes on third-party intellectual property rights.</li>
        </ul>
